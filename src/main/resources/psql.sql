...
DROP TABLE IF EXISTS equipment, serial_numbers, techno_map_stages, item_for_production, commodity_item,
...
VALUES ('1D243FD2314FV3', 1),
       ...
       ('G32YUG234TBGI5', 3),
       ('SDF9834HF92851', 4);
INSERT INTO techno_map_stages (name, index_in_techno_map, time_spent_in_seconds, money_expenses_in_rubles, workshop_map_id,
                   create_time, creator_id, serial_numbers_id)
